...
{
  new (message_memory) ros2_ws_interface::msg::Student(_init);
}

void Student_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_ws_interface::msg::Student *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Student_message_member_array[3] = {
  {
    ...
    offsetof(ros2_ws_interface::msg::Student, first_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_ws_interface::msg::Student, last_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_ws_interface::msg::Student, age),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Student_message_members = {
  "ros2_ws_interface::msg",  // message namespace
  "Student",  // message name
  3,  // number of fields
  sizeof(ros2_ws_interface::msg::Student),
...
get_message_type_support_handle<ros2_ws_interface::msg::Student>()
{
  return &::ros2_ws_interface::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_ws_interface, msg, Student)() {
  return &::ros2_ws_interface::msg::rosidl_typesupport_introspection_cpp::Student_message_type_support_handle;
}
