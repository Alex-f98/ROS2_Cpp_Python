...
#include "ros2_ws_interface/msg/detail/student__rosidl_typesupport_fastrtps_c.h"
...
using _Student__ros_msg_type = ros2_ws_interface__msg__Student;
...
size_t get_serialized_size_ros2_ws_interface__msg__Student(
  const void * untyped_ros_message,
...
static uint32_t _Student__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_ws_interface__msg__Student(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_ws_interface
size_t max_serialized_size_ros2_ws_interface__msg__Student(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_ws_interface__msg__Student;
    is_plain =
      (
...
static size_t _Student__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_ws_interface__msg__Student(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_ws_interface, msg, Student)() {
