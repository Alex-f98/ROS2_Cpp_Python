...
#include "ros2_ws_interface/msg/detail/student__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_ws_interface::msg::Student;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_ws_interface::msg::Student *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_ws_interface::msg::Student *>(
    untyped_ros_message);
...
{
  return &ros2_ws_interface::msg::typesupport_fastrtps_cpp::_Student__handle;
}
