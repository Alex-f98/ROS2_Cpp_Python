...
static const _GradePointAverage_Request_type_support_symbol_names_t _GradePointAverage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_ws_interface, srv, GradePointAverage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_ws_interface, srv, GradePointAverage_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_ws_interface, srv, GradePointAverage_Request)() {
  return &::ros2_ws_interface::srv::rosidl_typesupport_c::GradePointAverage_Request_message_type_support_handle;
}
...
static const _GradePointAverage_Response_type_support_symbol_names_t _GradePointAverage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_ws_interface, srv, GradePointAverage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_ws_interface, srv, GradePointAverage_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros2_ws_interface, srv, GradePointAverage_Response)() {
  return &::ros2_ws_interface::srv::rosidl_typesupport_c::GradePointAverage_Response_message_type_support_handle;
}
...
static const _GradePointAverage_type_support_symbol_names_t _GradePointAverage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_ws_interface, srv, GradePointAverage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros2_ws_interface, srv, GradePointAverage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ros2_ws_interface, srv, GradePointAverage)() {
  return &::ros2_ws_interface::srv::rosidl_typesupport_c::GradePointAverage_service_type_support_handle;
}
