...
static const _GradePointAverage_Request_type_support_symbol_names_t _GradePointAverage_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_ws_interface, srv, GradePointAverage_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_ws_interface, srv, GradePointAverage_Request)),
  }
};
...
{
  return &::ros2_ws_interface::srv::rosidl_typesupport_cpp::GradePointAverage_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_ws_interface, srv, GradePointAverage_Request)() {
  return get_message_type_support_handle<ros2_ws_interface::srv::GradePointAverage_Request>();
}
...
static const _GradePointAverage_Response_type_support_symbol_names_t _GradePointAverage_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_ws_interface, srv, GradePointAverage_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_ws_interface, srv, GradePointAverage_Response)),
  }
};
...
{
  return &::ros2_ws_interface::srv::rosidl_typesupport_cpp::GradePointAverage_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_ws_interface, srv, GradePointAverage_Response)() {
  return get_message_type_support_handle<ros2_ws_interface::srv::GradePointAverage_Response>();
}
...
static const _GradePointAverage_type_support_symbol_names_t _GradePointAverage_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_ws_interface, srv, GradePointAverage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_ws_interface, srv, GradePointAverage)),
  }
};
...
{
  return &::ros2_ws_interface::srv::rosidl_typesupport_cpp::GradePointAverage_service_type_support_handle;
}
