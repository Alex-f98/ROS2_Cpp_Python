...
bool ros2_ws_interface__msg__student__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_ws_interface.msg._student.Student", full_classname_dest, 38) == 0);
  }
  ros2_ws_interface__msg__Student * ros_message = _ros_message;
  {  // first_name
...
PyObject * ros2_ws_interface__msg__student__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_ws_interface.msg._student");
